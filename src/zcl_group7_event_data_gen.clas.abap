CLASS zcl_group7_event_data_gen DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_group7_event_data_gen IMPLEMENTATION.
    METHOD if_oo_adt_classrun~main.

    "===============================================================
    " DATA DECLARATIONS
    "===============================================================
    DATA: lt_events        TYPE TABLE OF zevent_7,
          ls_event         TYPE zevent_7,
          lt_participants  TYPE TABLE OF zparticipant_7,
          ls_participant   TYPE zparticipant_7,
          lt_regs          TYPE TABLE OF zregistration_7,
          ls_reg           TYPE zregistration_7,
          lv_ts            TYPE timestampl.

    "===============================================================
    " DELETE OLD DATA
    "===============================================================
    DELETE FROM zregistration_7.
    out->write( |Deleted Registrations: { sy-dbcnt }| ).

    DELETE FROM zparticipant_7.
    out->write( |Deleted Participants: { sy-dbcnt }| ).

    DELETE FROM zevent_7.
    ...
    INSERT zevent_7 FROM TABLE @lt_events.
    ...
    INSERT zparticipant_7 FROM TABLE @lt_participants.
    ...
    INSERT zregistration_7 FROM TABLE @lt_regs.
